...
const features = [
  ...
  },
  {
    ...
    description: "Access and chat with your PDFs seamlessly ob any device, whether it's your desktop, tablet, or smartphone.",
        ...
        <div className="flex flex-col justify-center items-center mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              ...
              <br />
              <br /> Upload ypur document, and our chatbot will answer questions, summarize content, and answer all your Qs. Ideal for everyone,<span className="text-indigo-600">Chat with PDF</span>{" "}
          ...
          <div className="relative overflow-hidden pt-16">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <Image
                ...
                width={2432}
                height={1442}
                className="mb-[-0%] rounded-xl shadow-2xl rinf-1 ring-gray-900/10"
              />
